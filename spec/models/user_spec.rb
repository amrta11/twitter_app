...
describe User do
  ...
  describe "accessible attributes" do
    ...
    it "should not allow to set admin" do
      expect do 
        User.new(name: "sample user", email: "user@example.com",
                 password: "foobar", password_confirmation: "foobar",
                 admin: true) 
  ...
  describe "with a password that is too short" do
    ...
    it { should_not be_valid }
    # it { should be_invalid } #=> synonym of should_not be_valid
  end
  ...
  describe "remember token" do
    before { @user.save }
    # it { @user.remember_token.should_not be_blank } same as bellow implementation
  ...
  describe "microposts associations" do
    ...
    it "should destroy associated microposts" do
      ...
      microposts.each do |micropost|
        ...
        # Below are the other two alternatives of above example
